...
/*---------------------------*/
    ...
    public class IODBPSD_3
    {
        ...
        // Note: idatas and ldatas removed due to C# limitation with overlapping reference types
        // Use cdatas and convert as needed using Marshal or unsafe code
    }
    [StructLayout(LayoutKind.Sequential,Pack=4)]
...
/*-------------*/
    ...
    public class ODBMDL_2
    {
        ...
        // Note: g_1shot removed due to C# limitation with overlapping reference types
        // Use first 4 bytes of g_rdata as needed
    }
    [StructLayout(LayoutKind.Sequential,Pack=4)]
